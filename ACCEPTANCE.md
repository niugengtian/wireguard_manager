...
| 真实浏览器用户流程 / Real browser user flow | VERIFIED | quota=2、配置下载、移动二维码、第三台拒绝、多条路由保存、reset 代次 2、delete、管理 UI 目视检查；错误日志为空 / complete route-policy and lifecycle browser flow; empty error log |
